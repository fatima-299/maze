...
def solution_cell(x,y):
    pygame.draw.rect(screen, YELLOW, (x+3, y+3, 5, 5), 0)             # used to show the solution
    pygame.display.update()                                        # has visited cell
...
def plot_route_back(x,y):
    ...
    while (x, y) != (10,10):                                     # loop until cell position == start position
...
plot_route_back(s*w, s*w)         # call the plot solution function
